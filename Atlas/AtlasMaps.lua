...
--************************************************
	...
	ShadowfangKeep = {
		...
		Continent = AtlasLocale["Eastern Kingdoms"];
		{ BLUE.."A) "..AtlasLocale["Entrance"] };
		{ BLUE.."B) "..AtlasLocale["Walkway"] };
		{ BLUE.."C) "..AtlasLocale["Walkway"] };
		{ BLUE..INDENT..AtlasLocale["Deathsworn Captain"].." ("..AtlasLocale["Rare"]..")", NPC, 3872 };
		...
		{ GREY.."8) "..AtlasLocale["Fenrus the Devourer"], NPC, 4274 };
		{ GREY..INDENT..AtlasLocale["Arugal's Voidwalker"], NPC, 4627 };
		{ GREY..INDENT..AtlasLocale["The Book of Ur"], OBJECT, 36738 };
		{ GREY.."9) "..AtlasLocale["Wolf Master Nandos"], NPC, 3927 };
		{ GREY.."10) "..AtlasLocale["Archmage Arugal"], NPC, 4275 };
	};
	Stratholme = {
