...
AtlasMaps = {
	RagefireChasm = {
		...
		GREY..INDENT.."Zelemar der Hasserfüllte";
		GREY.."4) Bazzalan";
	};
	WailingCaverns = {
	...
	TheTempleofAhnQiraj = {
		...
		BLUE.."A) Eingang";
		GREY.."1) Der Prophet Skeram (Draußen)";
	...
	BlackrockDepths = {
		...
		GREY..INDENT.."Ok'thor der Zerstörer";
		...
		GREY..INDENT.."Coren D�sterbr�u (Braufest)";
	...
	BlackrockSpireLower = {
		...
		GREY.."17) Oberanführer Wyrmthalak";
		GREY.."?) Brennende Teufelswache (Rar, Zufällig)";
	};
	BlackrockSpireUpper = {
		...
		GREY.."5) Kriegshäuptling Rend Schwarzfaust";
		GREY..INDENT.."Gyth";
		GREY.."6) Awbee";
		GREY.."7) Die Bestie";
	...
	Stratholme = {
		...
		ORNG.."Ruf: Argentumdämmerung";
		ORNG.."Key: Der scharlachrote Schlüssel (Scarlet)";
		ORNG.."Key: Schlüssel zur Stadt (Dienstboteneingang)";
	...
	Karazhan = {
		...
		GREY.."12) Hyakiss der Lauerer (Zufällig)";
		GREY..INDENT.."Rokad der Verheerer (Zufällig)";
		GREY..INDENT.."Shadikith der Gleiter (Zufällig)";
	};
	HCBloodFurnace = {
	...
	CFRTheSteamvault = {
		...
		GREY.."2) Arkaner Behälter (2. Fragment)";
	...
	AuchShadowLabyrinth = {
		...
		GREY.."5) Murmur";
		GREY.."6) Arkaner Behälter (1. Fragment)";
	...
	TempestKeepArcatraz = {
		...
		GREY.."2) Arkaner Behälter (3. Fragment)";
