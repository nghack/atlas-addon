...
if ( GetLocale() == "deDE" ) then
	...
	local myData = {
		DLEast = {
			...
			GREY.."5) Scholomance, ".._RED.."Westliche Pestländer";
			GREY.."6) Burg Schattenfang, ".._RED.."Silberwald";
			GREY.."7) Gnomeregan, ".._RED.."Dun Morogh";
			GREY.."8) Uldaman, ".._RED.."Ödland";
			GREY.."9) Pechschwingenhort, ".._RED.."Schwarzfelsspitze";
			...
			GREY.."10) Das Verlies, ".._RED.."Sturmwind";
			GREY.."11) Die Todesminen, ".._RED.."Westfall";
			GREY.."12) Zul'Gurub, ".._RED.."Schlingendorntal";
			GREY.."13) Karazhan, ".._RED.."Gebirgspass der Totenwinde";
			GREY.."14) Der Tempel von Atal'Hakkar, ".._RED.."Sümpfe des Elends";
			"";
			"";
