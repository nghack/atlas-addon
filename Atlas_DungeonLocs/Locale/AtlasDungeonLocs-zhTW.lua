...
if ( GetLocale() ==	"zhTW" ) then
	...
	local myData = {
		DLEast = {
			...
			GREY.."2) 祖阿曼, ".._RED.."鬼魂之地";
			GREY.."3) 血色修道院, ".._RED.."提里斯法林地";
			GREY.."4) 斯坦索姆, ".._RED.."東瘟疫之地";
			GREY..INDENT.."納克薩瑪斯, ".._RED.."病木林, 東瘟疫之地";
			GREY.."5) 通靈學院, ".._RED.."西瘟疫之地";
			GREY.."6) 影牙城堡, ".._RED.."銀松森林";
			GREY.."7) 諾姆瑞根, ".._RED.."丹莫洛";
			GREY.."8) 奧達曼, ".._RED.."荒蕪之地";
			GREY.."9) 黑翼之巢, ".._RED.."黑石塔";
			GREY..INDENT.."黑石深淵, ".._RED.."黑石山";
			GREY..INDENT.."黑石塔, ".._RED.."黑石山";
			GREY..INDENT.."融火之心, ".._RED.."黑石深淵";
			GREY.."10) 監獄, ".._RED.."暴風城";
			GREY.."11) 死亡礦坑, ".._RED.."西部荒野";
			GREY.."12) 祖爾格拉布, ".._RED.."荊棘谷";
			GREY.."13) 卡拉贊, ".._RED.."逆風小徑";
			GREY.."14) 沈沒的神廟, ".._RED.."悲傷沼澤";
			"";
			"";
			BLUE.."藍:"..ORNG.." 戰場";
			GREY.."灰:"..ORNG.." 副本";
