...
AtlasTransLocale = {
	...
	["Brackenwall Village"] = "Mur-de-Fougères";
		["Brann Bronzebeard's Camp"] = "Brann Bronzebeard's Camp"; -- à traduire
	...
	["Revantusk Village"] = "Village des Vengebroches";
		["River's Heart"] = "River's Heart"; -- à traduire
	...
	["Splintertree Post"] = "Poste de Bois-brisé";
		["Star's Rest"] = "Star's Rest"; -- à traduire
	["Stonard"] = "Pierrêche";
	...
	["Stranglethorn Vale"] = "Vallée de Strangleronce";
		["Sun Rock Retreat"] = "Sun Rock Retreat"; -- à traduire
	["Sun's Reach"] = "Confins du soleil";
		["Sunreaver's Command"] = "Sunreaver's Command"; -- à traduire
	...
	["Thalanaar"] = "Thalanaar";
	["The Aldor"] = "Les Aldor";
		["The Argent Stand"] = "The Argent Stand"; -- à traduire
	["The Barrens"] = "Les Tarides";
	["The Dark Portal"] = "Porte des ténèbres";
	["The Exodar"] = "L'Exodar";
		["The Forgotten Coast"] = "The Forgotten Coast"; -- à traduire
	...
	["Valormok"] = "Valormok";
		["Vengeance Landing"] = "Vengeance Landing"; -- à traduire
	...
	["Western Plaguelands"] = "Maleterres de l'ouest";
		["Westfall Brigade Encampment"] = "Westfall Brigade Encampment"; -- à traduire
	["Westfall"] = "Marche de l'Ouest";
		["Westguard Keep"] = "Westguard Keep"; -- à traduire
	["Wetlands"] = "Les Paluns";
	["Wildhammer Stronghold"] = "Bastion des Marteaux-hardis";
		["Windrunner's Overlook"] = "Windrunner's Overlook"; -- à traduire
	...
	["Zul'Drak"] = "Zul'Drak";
		["Valaar's Berth"] = "Valaar's Berth"; -- à traduire
		["Sun's Reach Sanctum"] = "Sun's Reach Sanctum"; -- à traduire
	["Darnassus"] = "Darnassus";
};
end