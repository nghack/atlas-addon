...
local myData = {
	AlteracValleyNorth = {
		...
		{ GREN.."2) "..AL["Arch Druid Renferal"] };
		{ GREN.."3) "..AL["Murgot Deepforge"] };
		{ GREN..INDENT..AL["Lana Thunderbrew <Blacksmithing Supplies>"] };
		{ GREN.."4) "..AL["Stormpike Stable Master <Stable Master>"] };
	...
	AlteracValleySouth = {
		...
		{ GREN.."2) "..AL["Lokholar the Ice Lord"].." ("..AL["Summon"]..")" };
		{ GREN.."3) "..AL["Wing Commander Vipore"].." ("..BF["Alliance"]..")" };
		{ GREN..INDENT..AL["Jotek"] };
		{ GREN..INDENT..AL["Smith Regzar"] };
		{ GREN..INDENT..AL["Primalist Thurloga"] };
		{ GREN.."4) "..AL["Frostwolf Stable Master <Stable Master>"] };
		{ GREN..INDENT..AL["Frostwolf Wolf Rider Commander"] };
		{ GREN.."5) "..AL["Frostwolf Quartermaster"] };
		{ GREN.."6) "..AL["Wing Commander Guse"].." ("..AL["Rescued"]..")" };
	...
	ZangarmarshPvP = {
		...
		{ GREN.."3) "..AL["Horde Field Scout"] };
		{ GREN.."4) "..AL["Alliance Field Scout"] };
