...
local myData = {
	AlteracValleyNorth = {
		ZoneName = { BZ["Alterac Valley"].." ("..ALC["North"]..", "..ALC["Alliance"]..")" };
		...
		{ GREN..INDENT..AL["Wing Commander Mulverick"].." ("..ALC["Horde"]..")" };
		...
		{ GREN..INDENT..AL["Wing Commander Jeztor"].." ("..ALC["Horde"]..")" };
		{ _RED.."5) "..BZ["Icewing Bunker"] };
		{ GREN..INDENT..AL["Wing Commander Guse"].." ("..ALC["Horde"]..")" };
		...
		{ GREN..INDENT..AL["Jeztor's Beacon"].." ("..ALC["Horde"]..")" };
		{ _RED.."9) "..AL["Eastern Crater"] };
		{ GREN..INDENT..AL["Slidore's Beacon"] };
		{ GREN..INDENT..AL["Guse's Beacon"].." ("..ALC["Horde"]..")" };
		...
		{ GREN..INDENT..AL["Mulverick's Beacon"].." ("..ALC["Horde"]..")" };
	};
	AlteracValleySouth = {
		ZoneName = { BZ["Alterac Valley"].." ("..ALC["South"]..", "..ALC["Horde"]..")" };
		...
		{ GREN..INDENT..AL["Wing Commander Slidore"].." ("..ALC["Alliance"]..")" };
		{ _RED.."4) "..AL["West Frostwolf Tower"] };
		{ GREN..INDENT..AL["Wing Commander Ichman"].." ("..ALC["Alliance"]..")" };
		...
		{ GREN.."2') "..AL["Wing Commander Vipore"].." ("..ALC["Alliance"]..")" };
	...
	ArathiBasin = {
		...
		PlayerLimit = "15";
		Acronym = AL["AB"];
		{ ORNG..ALC["Reputation"]..": "..ALIL["The League of Arathor"].." ("..ALC["Alliance"]..")" };
		{ ORNG..ALC["Reputation"]..": "..ALIL["The Defilers"].." ("..ALC["Horde"]..")" };
		{ BLUE.."A) "..BZ["Trollbane Hall"].." ("..ALC["Alliance"]..")" };
		{ BLUE.."B) "..BZ["Defiler's Den"].." ("..ALC["Horde"]..")" };
		{ GREN.."1) "..BZ["Stables"] };
		{ GREN.."2) "..BZ["Gold Mine"] };
	...
	WarsongGulch = {
		...
		PlayerLimit = "10";
		Acronym = AL["WSG"];
		{ ORNG..ALC["Reputation"]..": "..ALIL["Silverwing Sentinels"].." ("..ALC["Alliance"]..")" };
		{ ORNG..ALC["Reputation"]..": "..ALIL["Warsong Outriders"].." ("..ALC["Horde"]..")" };
		{ BLUE.."A) "..BZ["Silverwing Hold"].." ("..ALC["Alliance"]..")" };
		{ BLUE.."B) "..BZ["Warsong Lumber Mill"].." ("..ALC["Horde"]..")" };
	};
	SilithystMustFlow = {
	...
	EyeOfTheStorm = {
		...
		PlayerLimit = "15";
		Acronym = AL["EotS"];
		{ BLUE.."A) "..ALC["Entrance"].." ("..ALC["Alliance"]..")" };
		{ BLUE.."B) "..ALC["Entrance"].." ("..ALC["Horde"]..")" };
		{ _RED.."1) "..AL["Flag"] };
	...
	TheBattleForGilneas = {
		...
		LevelRange = "85+";
		MinLevel = "85";
		{ BLUE.."A) "..BZ["Gilnean Stronghold"].." ("..ALC["Alliance"]..")" };
		{ ORNG..INDENT..AL["Alliance Graveyard"] };
		{ BLUE.."B) "..BZ["Horde Landing"].." ("..ALC["Horde"]..")" };
		{ GREN.."1) "..BZ["Mines"] };
	...
	TolBarad = {
		...
		LevelRange = "80-85";
		MinLevel = "80";
		{ ORNG..ALC["Reputation"]..": "..ALIL["Baradin's Wardens"].." ("..ALC["Alliance"]..")" };
		{ ORNG..ALC["Reputation"]..": "..ALIL["Hellscream's Reach"].." ("..ALC["Horde"]..")" };
		{ BLUE.."A) "..AL["Attackers"] };
	...
	TwinPeaks = {
		...
		LevelRange = "85+";
		MinLevel = "85";
		{ ORNG..ALC["Reputation"]..": "..ALIL["Wildhammer Clan"].." ("..ALC["Alliance"]..")" };
		{ ORNG..ALC["Reputation"]..": "..ALIL["Dragonmaw Clan"].." ("..ALC["Horde"]..")" };
		{ BLUE.."A) "..AL["Wildhammer Longhouse"].." ("..ALC["Alliance"]..")" };
		{ BLUE.."B) "..AL["Dragonmaw Clan Compound"].." ("..ALC["Horde"]..")" };
