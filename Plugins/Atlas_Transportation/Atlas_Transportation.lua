...
--[[	TransAlliancePandaria = {
		...
		{ WHIT.." 1) "..BZ["Chun Tian Monastery"] };
		{ WHIT.." 2) "..BZ["Emperor's Omen"] };
		{ WHIT.." 3) "..BZ["Sha La Village"] };
		{ WHIT.." 4) "..BZ["Dawnblossom"] };
		{ WHIT.." 5) "..BZ["Tbe Arboretum"] };
		{ WHIT.." 6) "..BZ["Jade Temple Grounds"] };
		{ WHIT.." 7) "..BZ["Wayward Landing"] };
		{ WHIT.." 8) "..BZ["Glassfin Village"] };
		{ "" };
		{ BLUE..BZ["Valley of the Four Winds"] };
		{ WHIT.." 9) "..BZ["Stoneplow"] };
		{ WHIT.."10) "..BZ["Sentinel Basecamp"] };
		{ WHIT.."11) "..BZ["Halfhill"] };
		{ WHIT.."12) "..BZ["Grassy Cline"] };
		{ WHIT.."13) "..BZ["The Hidden Pass"] };
		{ WHIT.."14) "..BZ["Pang's Stead"] };
		{ "" };
		{ BLUE..BZ["Krasarang Wilds"] };
		{ WHIT.."15) "..BZ["Crane God Island"] };
		{ WHIT.."16) "..BZ["Marista"] };
		{ WHIT.."17) "..BZ["The Incursion"] };
		{ WHIT.."18) "..BZ["Zhu's Bastion"] };
		{ "" };
		{ BLUE..BZ["Kun-Lai Summit"] };
		{ WHIT.."19) "..BZ["Zouchin Village"] };
		{ WHIT.."20) "..BZ["White Tiger"] };
		{ WHIT.."21) "..BZ["Gate of Winter's Blossom"] };
		{ WHIT.."22) "..BZ["One Keg"] };
		{ WHIT.."23) "..BZ["Kota Basecamp"] };
		{ WHIT.."24) "..BZ["Eastwind Rest"] };
		{ WHIT.."25) "..BZ["Westwind Rest"] };
		{ WHIT.."26) "..BZ["Shado-Pan Retreat"] };
		{ WHIT.."27) "..BZ["Binan Village"] };
		{ "" };
		{ BLUE..BZ["Townlong Steppes"] };
		{ WHIT.."28) "..BZ["Longying Outpost"] };
		{ WHIT.."29) "..BZ["Shado-Pan Garrison"] };
		{ WHIT.."30) "..BZ["Rensai's Watchpost"] };
		{ WHIT.."31) "..BZ["Gao-Ran Battlefront"] };
		{ "" };
		{ BLUE..BZ["Dread Wastes"] };
		{ WHIT.."32) "..BZ["Sunset Brewgarden"] };
		{ WHIT.."33) "..BZ["Klaxxi'vess"] };
		{ WHIT.."34) "..BZ["Anglers Hub"] };
		{ "" };
		{ BLUE..BZ["Vale of Eternal Blossoms"] };
		{ WHIT.."35) "..BZ["Main Gate Dungeon"] };
		{ WHIT.."36) "..BZ["The Star's Ascent"] };
	};
	TransHordePandaria = {
		ZoneName = { BZ["Pandaria"].." ("..BF["Horde"]..")" };
		{ _RED..AL["Taxi Nodes"] };
		{ BLUE..BZ["The Jade Forest"] };
		{ WHIT.." 1) "..BZ["Hellscream's Hope"] };
		{ WHIT.." 2) "..BZ["Chun Tian Monastery"] };
		{ WHIT.." 3) "..BZ["Emperor's Omen"] };
		{ WHIT.." 4) "..BZ["Sha La Village"] };
		{ WHIT.." 5) "..BZ["Fort Grookin"] };
		{ WHIT.." 6) "..BZ["Dawnblossom"] };
		{ WHIT.." 7) "..BZ["Tbe Arboretum"] };
		{ WHIT.." 8) "..BZ["Jade Temple Grounds"] };
		{ "" };
		{ BLUE..BZ["Valley of the Four Winds"] };
		{ WHIT.." 9) "..BZ["Stoneplow"] };
		{ WHIT.."10) "..BZ["Halfhill"] };
		{ WHIT.."11) "..BZ["Grassy Cline"] };
		{ WHIT.."12) "..BZ["The Hidden Pass"] };
		{ WHIT.."13) "..BZ["Pang's Stead"] };
		{ "" };
		{ BLUE..BZ["Krasarang Wilds"] };
		{ WHIT.."14) "..BZ["Dawnchaser Retreat"] };
		{ WHIT.."15) "..BZ["Crane God Island"] };
		{ WHIT.."16) "..BZ["Marista"] };
		{ WHIT.."17) "..BZ["Zhu's Bastion"] };
		{ "" };
		{ BLUE..BZ["Kun-Lai Summit"] };
		{ WHIT.."18) "..BZ["Zouchin Village"] };
		{ WHIT.."19) "..BZ["White Tiger"] };
		{ WHIT.."20) "..BZ["Gate of Winter's Blossom"] };
		{ WHIT.."21) "..BZ["One Keg"] };
		{ WHIT.."22) "..BZ["Kota Basecamp"] };
		{ WHIT.."23) "..BZ["Eastwind Rest"] };
		{ WHIT.."24) "..BZ["Shado-Pan Retreat"] };
		{ WHIT.."25) "..BZ["Binan Village"] };
		{ "" };
		{ BLUE..BZ["Townlong Steppes"] };
		{ WHIT.."26) "..BZ["Longying Outpost"] };
		{ WHIT.."27) "..BZ["Shado-Pan Garrison"] };
		{ WHIT.."28) "..BZ["Rensai's Watchpost"] };
		{ WHIT.."29) "..BZ["Gao-Ran Battlefront"] };
		{ "" };
		{ BLUE..BZ["Dread Wastes"] };
		{ WHIT.."30) "..BZ["Sunset Brewgarden"] };
		{ WHIT.."31) "..BZ["Klaxxi'vess"] };
		{ WHIT.."32) "..BZ["Anglers Hub"] };
		{ "" };
		{ BLUE..BZ["Vale of Eternal Blossoms"] };
