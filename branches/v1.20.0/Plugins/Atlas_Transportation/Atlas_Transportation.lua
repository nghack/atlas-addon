...
local myData = {
	...
	TransAllianceWest = {
		...
		{ PURP.." B') "..BZ["Stormwind City"]..", "..BZ["Elwynn Forest"]..", "..BZ["Eastern Kingdoms"] };
	...
	TransHordeEast = {
		...
		{ WHIT.."53) "..BZ["Grom'gol Base Camp"]..", "..BZ["Northern Stranglethorn"] };
		{ WHIT.."55) "..BZ["Booty Bay"]..", "..BZ["The Cape of Stranglethorn"] };
		{ "" };
		...
		{ PURP.."47) "..BZ["Terror Wing Path"].."("..AL["The Bogpaddle Bullet"]..")" };
		{ "" };
		{ BLUE..BZ["Swamp of Sorrows"] };
		{ WHIT.."48) "..BZ["Bogpaddle"] };
		{ WHIT.."49) "..BZ["Stonard"] };
		{ "" };
		{ BLUE..BZ["Blasted Lands"] };
		{ WHIT.."50) "..BZ["Dreadmaul Hold"] };
		{ WHIT.."51) "..BZ["Sunveil Excursion"] };
		{ "" };
		{ BLUE..BZ["Northern Stranglethorn"] };
		{ WHIT.."52) "..BZ["Bambala"] };
		{ WHIT.."53) "..BZ["Grom'gol Base Camp"] };
		{ "" };
		{ BLUE..BZ["The Cape of Stranglethorn"] };
		{ WHIT.."54) "..BZ["Hardwrench Hideaway"] };
		{ WHIT.."55) "..BZ["Booty Bay"] };
		{ "" };
		{ BLUE..BZ["Vashj'ir"] };
		{ CYAN.."56) "..BZ["Smuggler's Scar"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."57) "..BZ["Sandy Beach"].." ("..AL["Seahorse"].." / "..AL["Wind Rider"]..")" };
		{ CYAN.."58) "..BZ["Silver Tide Hollow"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."59) "..BZ["Legion's Rest"].." ("..AL["Seahorse"]..")" };
		{ CYAN.."60) "..BZ["Stygian Bounty"].." ("..AL["Seahorse"].." / "..AL["Wind Rider"]..")" };
		{ CYAN.."61) "..BZ["Tenebrous Cavern"].." ("..AL["Seahorse"]..")" };
		{ "" };
		{ _RED..AL["Legend"] };
		{ PURP.."-- : "..AL["Portal / Waygate Path to the destination"] };
		{ CYAN.."-- : "..AL["Ship / Zeppelin sailing path to destination"] };
