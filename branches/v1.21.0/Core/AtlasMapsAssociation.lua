...
Atlas_EntToInstMatches = {
	...
	["CavernsOfTimeEnt"] =			{"CoTBlackMorass","CoTDragonSoul","CoTEndTime","CoTHyjal","CoTHyjalEnt","CoTHourOfTwilight","CoTOldHillsbrad","CoTOldStratholme","CoTWellOfEternity"};
...
Atlas_InstToEntMatches = {
	...
	["CoTDragonSoul"] =			{"CavernsOfTimeEnt"};
