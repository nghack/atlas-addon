...
-- maqjav@hotmail.com
-- Última Actualización (last update): 06/08/2007
-- Codigos:
...
AtlasMaps = {
	...
	[2] = {
		BlackrockDepths = {
			...
			GREY.."14) Señor G\195\179lem Argelmach"; --Bien
	...
	[3] = {
		...
		GruulsLair = {
			...
			GREY..INDENT.."Kiggler el Enloquecido"; --Bien
			GREY..INDENT.."Ciego el Vidente"; --Bien
			GREY..INDENT.."Olm el Invocador"; --Bien
			GREY..INDENT.."Krosh Manofuego"; --Bien
