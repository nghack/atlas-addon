...
Atlas_MapTypes = {
	...
	[2] = "Instances des Royaumes de l'Est";
...
AtlasMaps = {
	[1] = {
		...
		ZulFarrak = {
			...
			GREY..INDENT.."Ame en peine poudreuse (Rare)";
			GREY.."5) Sergent Bly";
		...
		CoTHyjal = {
			ZoneName = "GdT: Sommet d'Hyjal"; -- ou La bataille du Mont Hyjal
			Location = "Grottes du Temps, Tanaris";
			Acronym = "MH, GdT3";
			ORNG.."Harmonisation requise";
		...
		CoTOldHillsbrad = {
			ZoneName = "GdT: Contreforts de Hautebrande d'antan"; -- ou Fort-de-Durn
			Location = "Grottes du Temps, Tanaris";
			Acronym = "Durn, GdT1";
			ORNG.."Harmonisation requise";
			ORNG.."R\195\169put: Gardiens du Temps";
	...
	[2] = {
		...
		BlackrockSpireLower = {
			...
			Acronym = "LBRS / BRS1";
			Location = "Mont Rochenoire";
			ORNG.."Objet: Brasero d'invocation (Mor Grayhoof)";
			BLUE.."A) Entr\195\169e";
			GREY.."1) Vaelan";
			GREY.."2) Warosh";
		...
		TheSunkenTemple = {
			...
			BLUE.."A) Entr\195\169e";
			BLUE.."B) Escalier";
			BLUE.."C) Miniboss Troll (En haut)"; -- Balafreur, Loro, Hukku, Zolo, Mijan, Zul'Lor
		...
		Naxxramas = {
			...
			_RED..INDENT.."3) Les Quatre Cavaliers"; -- traduction à vérifier
	...
	[3] = {
		...
		AuchManaTombs = {
			...
			GREY.."2) Tavarok";
			GREY.."3) Panneau de contr\195\180le du transporteur \195\169therien"; -- traduction à vérifier
		...
		GruulsLair = {
			...
			GREY..INDENT.."Kiggler le Cinglé";
			GREY..INDENT.."Oeillaveugle le Voyant";
			GREY..INDENT.."Olm l'Invocateur";
			GREY..INDENT.."Krosh Brasemain";
		...
		BlackTempleBasement = {
			...
			GREY..INDENT.."Essence de col\195\168re";		-- traduction à verifier
		...
		BlackTempleMiddle = {
			...
			BLUE.."C) Vers Reliquary of Souls";		-- A traduire
		...
		BlackTempleTop = {
			...
			GREY.."1) Mère Shahraz";
			GREY.."2) Conseil Illidari";	-- traduction à vérifier
