...
if ( GetLocale() == "frFR" ) then
	...
	local myData = {
		DLEast = {
			...
			GREY..INDENT.."Naxxramas, ".._RED.."Maleterres de l'Est";
		...
		DLWest = {
			...
			GREY.."10) Les Contreforts de Hautebrande d'antan, ".._RED.."GdT, Tanaris";
			GREY..INDENT.."Le Noir Mar\195\169cage, ".._RED.."GdT, Tanaris";
			GREY..INDENT.."Bataille du Mont Hyjal, ".._RED.."GdT, Tanaris";
