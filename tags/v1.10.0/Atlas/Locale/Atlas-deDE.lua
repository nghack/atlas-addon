...
AtlasMaps = {
	[1] = {
		...
		CoTHyjal = {
			ZoneName = "HdZ: Schlacht um Berg Hyjal";
			Location = "H\195\182hlen der Zeit, Tanaris";
			Acronym = "Hyjal, HdZ 3";
                        ORNG.."Zugangsquest erforderlich";
			ORNG.."Ruf: Die W\195\164chter der Sande";
                        BLUE.."A) Eingang";
                        BLUE.."B) Allianz Basis";
	...
	[2] = {
		...
		Karazhan = {
			...
			GREY.."2) Moroes";
                        GREY..INDENT.."Baroness Dorothea M\195\188hlenstein (Zuf\195\164llig, Schatten-Priesterin)";
			GREY..INDENT.."Lady Catriona Von'Indi (Zuf\195\164llig, Heilig-Priesterin)";
			GREY..INDENT.."Lady Keira Beerhas (Zuf\195\164llig, Heilig-Paladin)";
			GREY..INDENT.."Baron Rafe Dreuger (Zuf\195\164llig, Vergeltungs-Paladin)";
			GREY..INDENT.."Lord Robin Daris (Zuf\195\164llig, Offensiv-Krieger)";
			GREY..INDENT.."Lord Crispin Ference (Zuf\195\164llig, Defensiv-Krieger)";
	...
	[3] = {
		...
		GruulsLair = {
			...
			GREY.."1) Hochk\195\182nig Raufgar";
                        GREY..INDENT.."Gicherer der Wahnsinnige";
			GREY..INDENT.."Blindauge der Seher";
			GREY..INDENT.."Olm der Beschw\195\182rer";
			GREY..INDENT.."Krosh Feuerhand";
