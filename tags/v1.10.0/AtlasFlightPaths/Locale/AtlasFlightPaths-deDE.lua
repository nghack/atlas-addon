...
if ( GetLocale() == "deDE" ) then
	...
	local myData = {
		...
		FPHordeOutland = {
			...
			GREY.."6) Shattrath, ".._RED.."W\195\164lder von Terokkar";
			GREY.."7) Steinbrecherfeste,";
			_RED..INDENT.."W\195\164lder von Terokkar";
			GREY.."8) Schattenmond, ".._RED.."Schattenmondtal";
			GREY.."9) Altar der Sha'tar, ".._RED.."SMT "..BLUE.."(Aldor)";
			GREY.."10) Sanktum der Sterne, ".._RED.."SMT "..BLUE.."(Seher)";
			GREY.."11) Garadar, ".._RED.."Nagrand";
			GREY.."12) Zabra'jin, ".._RED.."Zangarmarschen";
		...
		FPAllianceOutland = {
			...
			GREY.."6) Shattrath, ".._RED.."W\195\164lder von Terokkar";
			GREY.."7) Allerias Feste, ".._RED.."W\195\164lder von Terokkar";
			GREY.."8) Wildhammerfeste, ".._RED.."Schattenmondtal";
			GREY.."9) Altar der Sha'tar, ".._RED.."SMT "..BLUE.."(Aldor)";
			GREY.."10) Sanktum der Sterne, ".._RED.."SMT "..BLUE.."(Seher)";
			GREY.."11) Telaar, ".._RED.."Nagrand";
			GREY.."12) Oreborzuflucht, ".._RED.."Zangarmarschen";
