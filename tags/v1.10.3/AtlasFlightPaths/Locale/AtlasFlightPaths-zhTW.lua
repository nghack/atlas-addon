...
if ( GetLocale() ==	"zhTW" ) then
	...
	local myData = {
		...
		FPAllianceWest = {
			...
			GREY.."14) 泥鏈營地, ".._RED.."塵泥沼澤";
			GREY.."15) 羽月要塞, ".._RED.."菲拉斯";
			GREY.."16) 薩蘭納爾, ".._RED.."菲拉斯";
			GREY.."17) 馬紹爾營地, ".._RED.."安戈洛環形山";
			GREY.."18) 塞納里奧城堡, ".._RED.."希利蘇斯";
			GREY.."19) 加基森, ".._RED.."塔納利斯";
			GREY.."20) 艾克索達, ".._RED.."藍謎島";
		...
		FPHordeWest = {
			...
			GREY.."16) 泥鏈營地, ".._RED.."塵泥沼澤";
			GREY.."17) 莫沙徹營地, ".._RED.."菲拉斯";
			GREY.."18) 亂風崗, ".._RED.."千針石林";
			GREY.."19) 馬紹爾營地, ".._RED.."安戈洛環形山";
			GREY.."20) 塞納里奧城堡, ".._RED.."希利蘇斯";
			GREY.."21) 加基森, ".._RED.."塔納利斯";
			"";
			"";
			GREN.."綠色: 僅限德魯伊";
		};
