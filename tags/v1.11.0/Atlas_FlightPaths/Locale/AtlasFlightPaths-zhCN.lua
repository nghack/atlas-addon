...
if ( GetLocale() == "zhCN" ) then
	...
	local myData = {
		FPAllianceEast = {
			ZoneName = "联盟 [A] (东部)";
			Location = "东部王国";
			GREY.."1) 阳湾港, ".._RED.."奎尔丹纳斯岛";
			GREY.."2) 战斧岭, ".._RED.."幽魂之地";
			GREY.."3) 圣光之愿礼拜堂, ".._RED.."东瘟疫之地";
			GREY.."4) 冰风岗, ".._RED.."西瘟疫之地";
			GREY.."5) 鹰巢山, ".._RED.."辛特兰";
			GREY.."6) 南海镇, ".._RED.."希尔斯布莱德丘陵";
			GREY.."7) 避难谷地, ".._RED.."阿拉希高地";
			GREY.."8) 米奈希尔港, ".._RED.."湿地";
			GREY.."9) 铁炉堡, ".._RED.."丹莫罗";
			GREY.."10) 塞尔萨玛, ".._RED.."洛克莫丹";
			GREY.."11) 瑟银哨塔, ".._RED.."灼热峡谷";
			GREY.."12) 摩根的岗哨, ".._RED.."燃烧平原";
			GREY.."13) 暴风城, ".._RED.."艾尔文森林";
			GREY.."14) 湖畔镇, ".._RED.."赤脊山";
			GREY.."15) 哨兵岭, ".._RED.."西部荒野";
			GREY.."16) 夜色镇, ".._RED.."暮色森林";
			GREY.."17) 守望堡, ".._RED.."诅咒之地";
			GREY.."18) 反叛军营地, ".._RED.."荆棘谷";
			GREY.."19) 藏宝海湾, ".._RED.."荆棘谷";
		};
		FPAllianceWest = {
			ZoneName = "联盟 [B] (西部)";
			Location = "卡利姆多";
		...
		FPHordeEast = {
			...
			Location = "东部王国";
			GREY.."1) 阳湾港, ".._RED.."奎尔丹纳斯岛";
			GREY.."2) 银月城, ".._RED.."永歌森林";
			GREY.."3) 塔奎林, ".._RED.."幽魂之地";
			GREY.."4) 战斧岭, ".._RED.."幽魂之地";
			GREY.."5) 圣光之愿礼拜堂, ".._RED.."东瘟疫之地";
			GREY.."6) 幽暗城, ".._RED.."提瑞斯法林地";
			GREY.."7) 瑟伯切尔, ".._RED.."银松森林";
			GREY.."8) 塔伦米尔, ".._RED.."希尔斯布莱德丘陵";
			GREY.."9) 恶齿村, ".._RED.."辛特兰";
			GREY.."10) 落锤镇, ".._RED.."阿拉希高地";
			GREY.."11) 瑟银哨塔, ".._RED.."灼热峡谷";
			GREY.."12) 卡加斯, ".._RED.."荒芜之地";
			GREY.."13) 索瑞森废墟, ".._RED.."燃烧平原";
			GREY.."14) 斯通纳德, ".._RED.."悲伤沼泽";
			GREY.."15) 格罗姆高营地, ".._RED.."荆棘谷";
