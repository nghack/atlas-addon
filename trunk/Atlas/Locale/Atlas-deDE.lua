...
ATLAS_DDL_CONTINENT_EASTERN = "Instanzen der \195\150stlichen K\195\182nigreiche";
...
ATLAS_DDL_PARTYSIZE = "Gruppen Gr\195\182\195\159e";
ATLAS_DDL_PARTYSIZE_5 = "Instanzen f\195\188r 5 Spieler";
ATLAS_DDL_PARTYSIZE_10 = "Instanzen f\195\188r 10 Spieler";
ATLAS_DDL_PARTYSIZE_20TO40 = "Instanzen f\195\188r 20-40 Spieler";
...
AtlasMaps = {
	...
	TheTempleofAhnQiraj = {
		...
		GREY.."2) Die K\195\164ferfamilie (Optional)";
		GREY..INDENT.."Vem";
	...
	TempestKeepTheEye = {
		...
		GREY..INDENT.."Meisteringenieur Telonicus (J\195\164ger)";
		GREY..INDENT.."Gro\195\159astronom Capernian (Magier)";
		GREY..INDENT.."F\195\188rst Blutdurst (Paladin)";
	};
	GruulsLair = {
