...
if ( GetLocale() == "zhCN" ) then
	...
	local myData = {
		FPAllianceEast = {
			...
			GREY.."16) 反叛军营地, ".._RED.."荆棘谷";
			GREY.."17) 藏宝海湾, ".._RED.."荆棘谷";
			GREY.."18) 战斧岭, ".._RED.."幽魂之地";
		};
		FPAllianceWest = {
			ZoneName = "联盟 (西部)";
			Location = "卡利姆多";
		...
		FPHordeWest = {
			...
			GREY.."16) 泥链镇, ".._RED.."尘泥沼泽";
			GREY.."17) 莫沙彻营地, ".._RED.."菲拉斯";
			GREY.."18) 乱风岗, ".._RED.."千针石林";
			GREY.."19) 马绍尔营地, ".._RED.."安戈洛环形山";
			GREY.."20) 塞纳里奥要塞, ".._RED.."希利苏斯";
			GREY.."21) 加基森, ".._RED.."塔纳利斯";
			"";
			"";
			GREN.."绿色: 德鲁伊专用";
		};
