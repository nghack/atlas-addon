...
if ( GetLocale() ==	"zhTW" ) then
	...
	local myData = {
		FPAllianceEast = {
			...
			GREY.."16) 反抗軍營地, ".._RED.."荊棘谷 ";
			GREY.."17) 藏寶海灣, ".._RED.."荊棘谷";
			GREY.."18) 戰斧嶺, ".._RED.."鬼魂之地";
		};
		FPAllianceWest = {
			ZoneName = "聯盟 (西)";
			Location = "卡林多";
		...
		FPHordeEast = {
			ZoneName = "部落 (東)";
			Location = "東部王國";
			GREY.."1) 銀月城, ".._RED.."永歌森林";
			GREY.."2) 安寧地, ".._RED.."鬼魂之地";
			GREY.."3) 戰斧嶺, ".._RED.."鬼魂之地";
			GREY.."4) 聖光之願禮拜堂, ".._RED.."東瘟疫之地";
			GREY.."5) 幽暗城, ".._RED.."提里斯法林地";
			GREY.."6) 瑟伯切爾, ".._RED.."銀松森林";
			GREY.."7) 塔倫米爾, ".._RED.."希爾斯布萊德丘陵";
			GREY.."8) 惡齒村, ".._RED.."辛特蘭";
			GREY.."9) 落錘鎮, ".._RED.."阿拉希高地";
			GREY.."10) 瑟銀哨塔, ".._RED.."灼熱峽谷";
			GREY.."11) 卡加斯, ".._RED.."荒蕪之地";
			GREY.."12) 烈焰峰, ".._RED.."燃燒平原";
			GREY.."13) 斯通納德, ".._RED.."悲傷沼澤";
			GREY.."14) 格羅姆高營地, ".._RED.."荊棘谷";
			GREY.."15) 藏寶海灣, ".._RED.."荊棘谷";
		};
		FPHordeWest = {
			ZoneName = "部落 (西)";
			Location = "卡林多";
