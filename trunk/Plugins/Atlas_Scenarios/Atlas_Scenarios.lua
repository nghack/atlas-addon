...
--************************************************
	...
	SC_TheSecretsofRagefire = {
		...
		{ INDENT..YELL.."- "..AL["Stage 2"].." - "..AL["Reconnaissance"] };
		{ INDENT..INDENT..GREY..AL["Investigate the main chamber."] };
		{ INDENT..INDENT..GREN.."1) "..AL["Supply Crates"] };
		{ INDENT..INDENT..GREN.."2) "..AL["Proto-drake Eggs"] };
		{ INDENT..INDENT..GREN.."3) "..AL["Pandaria Artifacts"] };
		{ INDENT..YELL.."- "..AL["Stage 3"].." - "..AL["The Sealed Gate"] };
		{ INDENT..INDENT..GREY..AL["Help Ticker build a device to open the next gate."] };
		{ INDENT..INDENT.."C) "..AL["Sealed Gate"] };
		{ INDENT..INDENT..GREN.."1) "..AL["Battery"]..", "..AL["Pool Pony"] };
		{ INDENT..INDENT..GREN.."2) "..AL["Broken Proto-Drake Egg"] };
		{ INDENT..INDENT..GREN.."3) "..AL["Cannon Balls"] };
		{ INDENT..YELL.."- "..AL["Final Stage"].." - "..AL["Holdout"] };
		{ INDENT..INDENT..GREY..AL["Defend the Gob Squad while Patch establishes an escape route."] };
