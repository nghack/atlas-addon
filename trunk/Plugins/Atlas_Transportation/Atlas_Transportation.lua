...
local myData = {
	...
	TransAllianceOutland = {
		...
		{ WHIT.." 3) "..BZ["Honor Hold"] };
		{ WHIT.." 4) "..BZ["Temple of Telhamat"] };
		{ "" };
		{ BLUE..BZ["Zangarmarsh"] };
		{ WHIT.." 5) "..BZ["Telredor"] };
		{ WHIT.." 6) "..BZ["Orebor Harborage"] };
		{ "" };
		{ BLUE..BZ["Nagrand"] };
		{ WHIT.." 7) "..BZ["Telaar"] };
		{ "" };
