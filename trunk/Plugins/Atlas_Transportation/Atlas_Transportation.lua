...
local myData = {
	...
	TransAlliancePandaria = {
		...
		{ WHIT.."32) "..BZ["Soggy's Gamble"] };
		{ WHIT.."33) "..BZ["The Briny Muck"] };
		{ WHIT.."34) "..BZ["The Lion's Redoubt"] };
		{ WHIT.."35) "..BZ["The Sunset Brewgarden"] };
		{ "" };
	...
	TransHordePandaria = {
		...
		{ WHIT.." 1) "..BZ["Dawn's Blossom"] };
		{ WHIT.." 2) "..BZ["Emperor's Omen"] };
		{ WHIT.." 3) "..BZ["Grookin Hill"] };
		{ WHIT.." 4) "..BZ["Honeydew Village"] };
		{ WHIT.." 5) "..BZ["Jade Temple Grounds"] };
		{ WHIT.." 6) "..BZ["Serpent's Overlook"] };
		{ WHIT.." 7) "..BZ["Sri-La Village"] };
		{ WHIT.." 8) "..BZ["The Arboretum"] };
		{ WHIT.." 9) "..BZ["Tian Monastery"] };
		...
		{ WHIT.."21) "..BZ["Kota Basecamp"] };
		{ WHIT.."22) "..BZ["One Keg"] };
		{ WHIT.."23) "..BZ["Shado-Pan Fallback"] };
		{ WHIT.."24) "..BZ["Temple of the White Tiger"] };
		{ WHIT.."25) "..BZ["Winter's Blossom"] };
		{ WHIT.."26) "..BZ["Zouchin Village"] };
		{ "" };
		{ BLUE..BZ["Townlong Steppes"] };
